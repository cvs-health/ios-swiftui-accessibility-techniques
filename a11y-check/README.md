...
Static analysis for Swift/SwiftUI accessibility issues, mapped to [WCAG 2.2](https://www.w3.org/TR/WCAG22/) success criteria. Runs on your source files and reports missing labels, incorrect traits, touch target sizes, color contrast, dynamic type, and more — with 35 rules across 19 WCAG criteria. Includes a **WCAG 2.2 scoring system** that grades your files or entire project from 0–100.
...
| **Grouping** | `missing-accessibility-grouping`, `zstack-order-confusing` | 1.3.1, 1.3.2 | Minor, Minor |
