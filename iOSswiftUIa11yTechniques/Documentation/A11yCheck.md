# A11y-check
`a11y-check` is a static analysis tool that scans SwiftUI source code for accessibility issues. It includes 44 rules across 23 WCAG 2.2 success criteria, with a 0–100 scoring system.
