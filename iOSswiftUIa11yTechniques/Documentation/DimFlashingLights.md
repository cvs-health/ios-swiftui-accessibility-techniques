...
Do not use flashing content as it can cause migraines, dizziness, nausea, and seizures. 

If flashing content is used then support the Dim Flashing Lights accessibility setting and stop the flashing. 
