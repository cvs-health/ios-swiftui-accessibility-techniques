        ...
        ScrollView {
            VStack {
                ...
                Divider()
                    ...
                    .padding(.bottom)
                Text("Good Example Multi-Selection List")
                    .font(.subheadline)
                    .fontWeight(.bold)
                    .frame(maxWidth: .infinity, alignment: .leading)
                    .accessibilityAddTraits(.isHeader)
                ...
                DisclosureGroup("Details") {
                    Text("The good multi-selection list example uses `.accessibilityAddTraits(.isSelected)` when the item is selected so VoiceOver announces the selected state. `.accessibilityRemoveTraits(.isButton)` removes the redundant \"Button\" trait from each row. `.accessibilityValue()` provides \"Selected\" or \"Not Selected\" value text. A visible checkmark and highlighted background indicate the selected state visually.")
                }
                .padding(.bottom).accessibilityHint("Good Example Multi-Selection List")
                Text("Bad Example")
                    .font(.subheadline)
                    .fontWeight(.bold)
                    .frame(maxWidth: .infinity, alignment: .leading)
