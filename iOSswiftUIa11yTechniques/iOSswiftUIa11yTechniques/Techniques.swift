...
let techniques: [Techniques] = [
    ...
    Techniques(name: "Accessibility Traits"),
    Techniques(name: "Accessibility Custom Content"),
    ...
    Techniques(name: "Motion Actuation"),
    ...
    Techniques(name: "XCTest Accessibility")
]
